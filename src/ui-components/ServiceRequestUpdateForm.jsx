...
export default function ServiceRequestUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = serviceRequestRecord
      ...
      : initialValues;
    setServiceRequestName(cleanValues.serviceRequestName);
    setServiceRequestDescription(cleanValues.serviceRequestDescription);
    ...
    setCurrentLocation(cleanValues.currentLocation);
    setErrors({});
  };
